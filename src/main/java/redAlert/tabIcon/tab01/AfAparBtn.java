 ...
 * 
 * 这个和其他防御建筑完全不同
 * 需要重写父类的方法  以及写自己的构造方法
 */
public class AfAparBtn extends Tab01ConstIcon {

	private static final long serialVersionUID = 1L;
	
	public AfAparBtn() {
		List<ShapeUnitFrame> list = ShpResourceCenter.loadShpResource("aparicon", "cameo", false);
	...
	public boolean isDisplay() {
		if(ShapeUnitResourceCenter.containsBuildingClass(AfAirc.class)) {
			return true;
		}else {
			return false;
		}
