 ...
 * 超时空转换
 */
public class AfChroBtn extends Tab01ConstIcon {
private static final long serialVersionUID = 1L;
	
	public AfChroBtn() {
		List<ShapeUnitFrame> list = ShpResourceCenter.loadShpResource("chroicon", "cameo", false);
	...
	public boolean isDisplay() {
		if(ShapeUnitResourceCenter.containsBuildingClass(AfCsph.class)) {
			return true;
		}else {
			return false;
		}
