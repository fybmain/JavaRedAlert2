 ...
 * 闪电风暴
 */
public class AfLightntingStormBtn extends Tab01ConstIcon {
	private static final long serialVersionUID = 1L;
	
	public AfLightntingStormBtn() {
		List<ShapeUnitFrame> list = ShpResourceCenter.loadShpResource("bolticon", "cameo", false);
	...
	public boolean isDisplay() {
		if(ShapeUnitResourceCenter.containsBuildingClass(AfWeth.class)) {
			return true;
		}else {
			return false;
		}
